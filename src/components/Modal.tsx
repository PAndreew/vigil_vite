            ...
            <Card className="bg-slate-950 border-purple-500/30 text-white shadow-2xl animate-in fade-in slide-in-from-top-2 duration-300 rounded-none">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-lg font-semibold font-grotesque">Sensitive Data Detected</h2>
                    </div>
                ...
                <CardFooter className="flex-col items-start gap-4 pt-4">
                    <div className="flex justify-between w-full">
                        <Button variant="ghost" className="hover:bg-slate-800 rounded-full px-4 font-grotesque text-lg" onClick={handleClose}>
                            Cancel
                        </Button>
                        <div className="flex gap-2">
                            <Button variant="outline" className="border-purple-500/50 text-purple-300 hover:bg-purple-900/30 hover:text-purple-200 rounded-full px-6 font-grotesque text-lg" onClick={handlePasteOriginal}>
                                Paste Original
                            </Button>
                            <Button className="bg-purple-600 hover:bg-purple-700 text-white rounded-full px-6 font-grotesque text-lg" onClick={handlePasteModified}>
                                Paste Redacted
                            </Button>
                        </div>
                    </div>
                    <div className="text-sm text-slate-500 flex items-center gap-2 font-grotesque">
                        <span>Hotkeys:</span>
                        <kbd className="font-sans px-1.5 py-0.5 text-sm font-semibold text-slate-300 bg-purple-900/40 border border-purple-500/30 rounded-md font-grotesque">Alt + R</kbd> <span>Redact,</span>
                        <kbd className="font-sans px-1.5 py-0.5 text-sm font-semibold text-slate-300 bg-purple-900/40 border border-purple-500/30 rounded-md font-grotesque">Alt + O</kbd> <span>Original</span>
                    </div>
                </CardFooter>
            </Card>
        </div>
